...
class Bossleft(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect = self.image.get_rect()
        self.frame = 0
        self.rect.center = SCREENRECT.midleft
        self.speed = 0
...
def main(winstyle = 0):
    ...
    Bossleft.images = load_images('bossleftsmall.png','bossleftsmall.png','bossleftsmall.png')
    ...
    while player.alive():
        ...
        if len(pygame.sprite.groupcollide(shields, shots, 1, 1))>0:
            Bossleft.speed=5
